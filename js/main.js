...
function coursePreviewVideo(){
    const coursePreviewModel = document.querySelector(".js-course-preview-model");
...
// to close menu when click outside it 
...
function styleSwitcherToggle(){
    const styleSwitcher = document.querySelector(".js-style-switcher"), styleSwitcherToggler = document.querySelector(".js-style-switcher-toggler");
